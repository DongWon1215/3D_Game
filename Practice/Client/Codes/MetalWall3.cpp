...
#include "..\Headers\MetalWall3.h"

USING(Client)

CMetalWall3::CMetalWall3(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CMetalWall3::CMetalWall3(const CMetalWall3 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CMetalWall3::Ready_GameObject_Prototype() // 원본객체의 초기화.
{

	return S_OK;
}

HRESULT CMetalWall3::Ready_GameObject(void* pArg) // 복제된객체의 추가 초기화.
{
...
_int CMetalWall3::Update_GameObject(_double TimeDelta)
{
...
_int CMetalWall3::LateUpdate_GameObject(_double TimeDelta)
{
...
HRESULT CMetalWall3::Render_GameObject()
{
...
HRESULT CMetalWall3::Add_Component()
{
	// For.Com_Shader
	...
	// For.Com_Mesh
	if (FAILED(CGameObject::Add_Component(SCENE_STAGE, L"Component_Mesh_MetalWall3", L"Com_Mesh", (CComponent**)&m_pMeshCom)))
		return E_FAIL;
...
HRESULT CMetalWall3::SetUp_ConstantTable()
{
	if (nullptr == m_pShaderCom || 
...
HRESULT CMetalWall3::SetUp_OnTerrain()
{
	CManagement*	pManagement = CManagement::GetInstance();
	if (nullptr == pManagement)
		return -1;
...
CMetalWall3 * CMetalWall3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CMetalWall3* pInstance = new CMetalWall3(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject_Prototype()))
	{
		MSG_BOX("Failed while Creating CMetalWall3");
...
CGameObject * CMetalWall3::Clone_GameObject(void* pArg)
{
	CMetalWall3* pInstance = new CMetalWall3(*this);
