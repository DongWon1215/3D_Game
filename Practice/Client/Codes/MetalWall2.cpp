...
#include "..\Headers\MetalWall2.h"

USING(Client)

CMetalWall2::CMetalWall2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CMetalWall2::CMetalWall2(const CMetalWall2 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CMetalWall2::Ready_GameObject_Prototype() // 원본객체의 초기화.
{

	return S_OK;
}

HRESULT CMetalWall2::Ready_GameObject(void* pArg) // 복제된객체의 추가 초기화.
{
...
_int CMetalWall2::Update_GameObject(_double TimeDelta)
{
...
_int CMetalWall2::LateUpdate_GameObject(_double TimeDelta)
{
...
HRESULT CMetalWall2::Render_GameObject()
{
...
HRESULT CMetalWall2::Add_Component()
{
	// For.Com_Shader
	...
	// For.Com_Mesh
	if (FAILED(CGameObject::Add_Component(SCENE_STAGE, L"Component_Mesh_MetalWall2", L"Com_Mesh", (CComponent**)&m_pMeshCom)))
		return E_FAIL;
...
HRESULT CMetalWall2::SetUp_ConstantTable()
{
	if (nullptr == m_pShaderCom || 
...
HRESULT CMetalWall2::SetUp_OnTerrain()
{
	CManagement*	pManagement = CManagement::GetInstance();
	if (nullptr == pManagement)
		return -1;
...
CMetalWall2 * CMetalWall2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CMetalWall2* pInstance = new CMetalWall2(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject_Prototype()))
	{
		MSG_BOX("Failed while Creating CMetalWall2");
...
CGameObject * CMetalWall2::Clone_GameObject(void* pArg)
{
	CMetalWall2* pInstance = new CMetalWall2(*this);
