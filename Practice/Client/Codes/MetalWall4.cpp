...
#include "..\Headers\MetalWall4.h"

USING(Client)

CMetalWall4::CMetalWall4(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CMetalWall4::CMetalWall4(const CMetalWall4 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CMetalWall4::Ready_GameObject_Prototype() // 원본객체의 초기화.
{

	return S_OK;
}

HRESULT CMetalWall4::Ready_GameObject(void* pArg) // 복제된객체의 추가 초기화.
{
...
_int CMetalWall4::Update_GameObject(_double TimeDelta)
{
...
_int CMetalWall4::LateUpdate_GameObject(_double TimeDelta)
{
...
HRESULT CMetalWall4::Render_GameObject()
{
...
HRESULT CMetalWall4::Add_Component()
{
	// For.Com_Shader
	...
	// For.Com_Mesh
	if (FAILED(CGameObject::Add_Component(SCENE_STAGE, L"Component_Mesh_MetalWall4", L"Com_Mesh", (CComponent**)&m_pMeshCom)))
		return E_FAIL;
...
HRESULT CMetalWall4::SetUp_ConstantTable()
{
	if (nullptr == m_pShaderCom || 
...
HRESULT CMetalWall4::SetUp_OnTerrain()
{
	CManagement*	pManagement = CManagement::GetInstance();
	if (nullptr == pManagement)
		return -1;
...
CMetalWall4 * CMetalWall4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CMetalWall4* pInstance = new CMetalWall4(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject_Prototype()))
	{
		MSG_BOX("Failed while Creating CMetalWall4");
...
CGameObject * CMetalWall4::Clone_GameObject(void* pArg)
{
	CMetalWall4* pInstance = new CMetalWall4(*this);
