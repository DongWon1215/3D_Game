...
class CRiffle final : public CGameObject
{
private:
	explicit CRiffle(LPDIRECT3DDEVICE9 pDevice);
	explicit CRiffle(const CRiffle& rhs);
	virtual ~CRiffle() = default;
...
private:
	...
	_float					m_fCoolTime;					  //ÃÑ¾Ë ¹ß»ç ÄðÅ¸ÀÓ
...
public:
	static CRiffle* Create(LPDIRECT3DDEVICE9 pDevice);
