...
const DWORD KEY_F1 = 0x00020000;
const DWORD KEY_F2 = 0x00040000;
const DWORD KEY_F3 = 0x00080000;
const DWORD KEY_F4 = 0x00100000;


class CKey : public CBase
{
	DECLARE_SINGLETON(CKey)
...
public:
	void Componenet_Update(_double deltaTime);
